...
private String callGeminiApiWithModel(
    ...
    @Transactional
    public ResponseEntity<?> sendMessage(ChatMessageDto messageDto, Authentication authentication) {
    ...
    public ResponseEntity<?> ListChatHistory(Authentication authentication) {
        List<ChatMessageDto> history = getChatHistory(authentication);
        ApiResponse<?> apiResponse = ApiResponse.builder().
                statusCode(HttpStatus.OK.value()).
    ...
    @Transactional
    public ResponseEntity<?> deleteChatHistory(Authentication authentication) {
