package com.webjob.application.Configs.Aspect;

import com.webjob.application.Annotation.RateLimit;

import com.webjob.application.Utils.exceptions.TooManyRequestsException;
...
public class RateLimitAspect {
    ...
    public Object rateLimit(ProceedingJoinPoint joinPoint, RateLimit rateLimit) throws Throwable {
        ...
        if (count == null) {
            ...
            redisTemplate.opsForValue().set(blacklistKey, "BLOCKED", Duration.ofMinutes(3));
