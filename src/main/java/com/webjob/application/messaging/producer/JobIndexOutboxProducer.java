...
@Slf4j
public class JobIndexOutboxProducer {
    ...
    public void publishEvents() {
        ...
        log.info("Starting JobIndex scheduled batch publication of {} outbox events", events.size());
        for (OutboxEvent event : events) {
            publish(event);
        }
        log.info("Finished JobIndex scheduled batch publication cycle");
    }
